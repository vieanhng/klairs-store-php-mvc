    ...
    <div class="container">
        <div class="row d-xxl-flex justify-content-center justify-content-xxl-center">
            <div class="col-12 col-md-6 col-xl-9 col-xxl-10">
                ...
                <div style="text-align: center;margin-top: 21px;"><a href="<?=getUrl('users/orderHistory/orderId/'.$_GET['orderCode'])?>"><button class="btn btn-primary -dark" type="button" style="transform: scale(0.77);">Xem thông tin đơn hàng</button></a></div>
