    ...
    <div class="container">
        <div class="row d-xxl-flex justify-content-center justify-content-xxl-center">
            <div class="col-12 col-md-6 col-xl-9 col-xxl-10">
                ...
                <div style="text-align: center;margin-top: 12px;"><span style="color: rgb(33, 37, 41);">Mã đơn hàng của bạn là #12</span></div>
                <div style="text-align: center;margin-top: 21px;"><button class="btn btn-primary -dark" type="button" style="transform: scale(0.77);">Xem thông tin đơn hàng</button></div>
